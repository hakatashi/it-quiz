module.exports = {
  title: 'it-quiz', // populated into `publication.json`, default to `title` of the first entry or `name` in `package.json`.
  author: 'Koki Takahashi <hakatasiloving@gmail.com>', // default to `author` in `package.json` or undefined.
